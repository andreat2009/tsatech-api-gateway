    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        return http
            ...
            .authorizeExchange(exchange -> exchange
                ...
                .pathMatchers(HttpMethod.GET, "/api/shipping-methods", "/api/shipping-methods/**").permitAll()
                ...
                .pathMatchers(HttpMethod.POST, "/api/inventory/reserve", "/api/inventory/release").permitAll()
